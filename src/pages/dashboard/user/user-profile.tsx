...
const mockUserData = {
  ...
  bio: "Digital marketing professional with a passion for technology and innovation.",
  avatar: null,
  preferences: {
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 mt-2">
                    ...
                    <Badge variant="outline">User ID: {formData.id}</Badge>
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm">Account Status: {formData.accountStatus}</span>
                </div>
              </div>
            </CardContent>
          </Card>
